...
function KidsBedroom() {
  return (
    <GuidePage title="Kids Room Air Conditioning" icon="🧸">
      <div className="infoBlock">
        <h2>❄️ Kids Room Unit</h2>

        <img
          src="/images/kids-room-aircon.jpg"
          alt="Kids room air conditioning unit"
          className="guideImage"
        />

        <p>
          This air conditioning unit cools the kids room. It is best used for
      ...
      <div className="infoBlock">
        ...
        <ol>
          ...
          <li>Alternatively, use the ceiling fan, which is very effective.</li>
        </ol>
      ...
      <div className="infoBlock">
        ...
        <p>
          The full kids room air conditioning manual will be available here once added.
        </p>

        <a
          href="/manuals/kids-room-aircon-manual.pdf"
          target="_blank"
          rel="noreferrer"
          className="manualLink"
        >
          📄 Open Kids Room Air Conditioning Manual
        </a>
      </div>
    </GuidePage>
  )
